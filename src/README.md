...
- `/admin/projects`: valid Projects parent destination; scrolls to the Projects masthead and settles to `/admin/projects/classification` through observation when project content exists.
- `/admin/projects/classification`, `/admin/projects/intro`, `/admin/projects/media`, `/admin/projects/links`, `/admin/projects/tech`, `/admin/projects/lists`, `/admin/projects/challenges`, `/admin/projects/agent`: route-addressable Projects subsection scroll targets for the selected project record.
