...
- `useProjectViewportPreview.js`: bridges scroll-driven project viewport activation to the existing source-aware preview owner while respecting modal, interaction, marquee, and reduced-motion guardrails.
...
- `useViewportActivationGroup.js`: tracks registered card nodes and selects one viewport-active item with diagonal viewport scoring, scroll measurement notifications, and exported pure helpers.
